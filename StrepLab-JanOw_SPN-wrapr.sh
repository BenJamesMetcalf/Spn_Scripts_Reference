...
#if [[ -e $final_result_Dir/UPDATR_SPN_"$batch_name"_Typing_Results.txt ]]
#then
#    bLactam-PBP_DB-Updater.sh -r $allDB_dir -u $final_result_Dir/UPDATR_SPN_"$batch_name"_Typing_Results.txt -t $final_result_Dir/TABLE_SPN_"$batch_name"_Typing_Results.txt -s $final_result_Dir/SAMPL_SPN_"$batch_name"_Typing_Results.txt
#fi
